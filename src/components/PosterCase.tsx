...
// Картинки для идеи (вдохновение)
import warhol from "../assets/case/warhol.jpg";
import hendrix from "../assets/case/hendrix.jpg";
import joplin from "../assets/case/joplin.jpg";
import th13thfl from "../assets/case/13thfl.jpg";

// Картинки для типографики
import typo1 from "../assets/case/typo-1.jpg";
import typo2 from "../assets/case/typo-2.jpg";
import typo3 from "../assets/case/typo-3.jpg";
import typo4 from "../assets/case/typo-4.jpg";

// Картинки для постеров
import poster1 from "../assets/case/poster-1.jpg";
import poster2 from "../assets/case/poster-2.jpg";
import poster3 from "../assets/case/poster-3.jpg";
import poster4 from "../assets/case/poster-4.jpg";

// Финальная картинка
import posterFinal from "../assets/case/poster.jpg";
    ...
    <div className="project-modal">
      ...
      <div className="modal-hero">
        <div className="modal-hero-bg">
          <img src={mainPoster} alt="Психоделические постеры" />
                ...
                <div className="idea-visual-container">
                  <div className="idea-grid-2x2">
                    <div className="grid-item">
                      <img src={warhol} alt="Уорхолл" />
                    </div>
                    <div className="grid-item">
                      <img src={hendrix} alt="Hendrix Electric Ladyland" />
                    </div>
                    <div className="grid-item">
                      <img src={joplin} alt="Janis Joplin" />
                    </div>
                    <div className="grid-item">
                      <img src={th13thfl} alt="13 floor elevators" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="process-step reveal">
              <div className="idea-wrapper">
                <div className="idea-visual-container">
                  <div className="idea-grid-2x2">
                    <div className="grid-item">
                      <img src={typo1} alt="Groovy Beach Regular" />
                    </div>
                    <div className="grid-item">
                      <img src={typo2} alt="Шрифт в перспективе" />
                    </div>
                    <div className="grid-item">
                      <img src={typo3} alt="Псевдо-3D эффект" />
                    </div>
                    <div className="grid-item">
                      <img src={typo4} alt="Экструзия" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="idea-visual-container">
                  <div className="idea-grid-2x2">
                    <div className="grid-item-poster">
                      <img src={poster1} alt="Постер 1: жёлтый/тёмный" />
                    </div>
                    <div className="grid-item-poster">
                      <img src={poster2} alt="Постер 2: розовый/синий" />
                    </div>
                    <div className="grid-item-poster">
                      <img src={poster3} alt="Постер 3: фиолетовый/зелёный" />
                    </div>
                    <div className="grid-item-poster">
                      <img src={poster4} alt="Постер 4: оранжевый/красный" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="process-step reveal">
              <div className="process-step-image placeholder unpadding-right">
                <div className="mockup-item-final">
                  <img src={posterFinal} alt="Финальный коллаж" />
                </div>
              </div>
              <div className="process-step-content">
                <h3>Результат</h3>
